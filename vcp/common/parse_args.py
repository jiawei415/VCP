...
def common_arg_parser():
    ...
    parser.add_argument('--log_path', help='Directory to save learning curve data.', default="~/results/her", type=str)
    ...
    parser.add_argument('--alg_config', type=str, default="{}",
                        help="algorithm config e.g., {'k_heads':16,'only_her_data':False,'all_heads_play':True}")
    return parser
